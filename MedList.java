...
@CucumberOptions(
        features = {"features/pharmacist-portal/patient-comments-report-population-dashboard-and-quality-tab/MedList.feature"},
        glue = { "com.arine.automation.glue"},
        tags ="@MedListVerify",
        monochrome = true
)
public class MedList extends BaseRunner {
